...
def buy_books():
    ...
    return render_template('buy_books.html', active_page='buy_books', user=current_user, sales_listings=sales_listings)
...
def profile():
    ...
    return render_template('profile.html', active_page='profile', user=current_user, user_sales=user_sales)
